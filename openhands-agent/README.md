...
| `sub_domain` | Sub Domain | The sub domain to serve the OpenHands services at. | dns | string | `openhands` |
...
| --- | --- | --- | --- | --- | --- |
| `llm_api_key` | LLM API Key | The SDK requires an LLM API key from any LiteLLM-supported provider. | True | `openhands` | `llm-api-key` |
...
```mermaid
graph TD
  openhands_ingress["openhands_ingress<br/>5-km-openhands-ingress.toml"]
  openhands_configmap["openhands_configmap<br/>3-km-openhands-configmap.toml"]
  karpenter_nodepools["karpenter_nodepools<br/>1-karpenter-nodepools.toml"]
  openhands_rbac["openhands_rbac<br/>2-km-openhands-rbac.toml"]
  openhands["openhands<br/>4-km-openhands.toml"]
  certificate["certificate<br/>1-certificate.toml"]


  class openhands_ingress,openhands_configmap,karpenter_nodepools,openhands_rbac,openhands,certificate tfClass;
