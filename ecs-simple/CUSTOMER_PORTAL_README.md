...
A simple example of provisioning an AWS ECS cluster with a `whoami` HTTP server.
...
- Component (the Terraform to deploy whoami ECS service, container image, AWS TLS certificate, and ALB)
